...
if (isset($_POST['btn_signup'])) {
    ...
    $insQry = "INSERT INTO tbl_userregistration (user_name, user_email, user_password, user_address, user_gender, user_contact, user_photo, place_id) 
               VALUES ('$name', '$email', '$password', '$address', '$gender', '$contact', '$photo', '$place')";
        if ($Con->query($insQry)) {
    ...
    <form action="" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input required type="text" class="form-control" name="txt_contact" id="txt_contact" pattern="[7-9]{1}[0-9]{9}" title="Phone number must start with 7-9 followed by 9 digits." />
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <select name="txt_district" class="custom-select" id="txt_district" onchange="getPlace(this.value)">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <select name="txt_place" class="custom-select" id="txt_place">
