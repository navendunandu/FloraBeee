...
">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="Decoration.php" class="nav-link">DECORATION</a></li>
            <li class="nav-item"><a href="UserBooking.php" class="nav-link">USER BOOKING</a></li>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                <a class="dropdown-item" href="Complaints.php">COMPLAINTS</a>
                <a class="dropdown-item" href="../Guest/LogOut.php">LOGOUT</a>
              </div>
            </li>
	        </ul>
	      </div>
