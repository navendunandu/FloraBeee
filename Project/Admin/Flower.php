...
if(isset($_POST['btn_submit']))
{
	...
	if($id!='')
	{
	$upQry=" update tbl_flower set flower_name ='$Name' where flower_id='$id' ";
	if($Con->query($upQry))
	{
		?>
        <script>
		alert("Updated")
		window.location="Flower.php"
		</script>
        <?php
	}
	}
	else
	{
        ...
        $insQry = "insert into tbl_flower(flower_name)values('".$Name."')";
        if($Con->query($insQry))
        {
        ?>
            <script>
...
if(isset($_GET['did'])){
	$delQry="delete from tbl_flower where flower_id=".$_GET['did'];
	if($Con -> query($delQry))
	{
		echo "Deleted";
	}
...
if(isset($_GET['eid']))
{
	$SelQry=" select * from tbl_flower where flower_id='".$_GET['eid']."' ";
	$result=$Con->query($SelQry);
	$data=$result->fetch_assoc();
	$did=$data['flower_id'];
	$dname=$data['flower_name'];
}
?>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <p>  <a href="Flower.php?did=<?php echo $data['flower_id']; ?>">Delete</a></p>
                            <p> <a href="Flower.php?eid=<?php echo $data['flower_id']; ?>">Edit</a></p>
                        </td>
                    </tr>
                    <?php
                    }
