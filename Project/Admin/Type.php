...
if(isset($_POST['btn_submit']))
{
	...
	if($id!='')
	{
	$upQry=" update tbl_type set type_name ='$Name' where type_id='$id' ";
	if($Con->query($upQry))
	{
		?>
        <script>
	...
	else
	{
        ...
        $insQry = "insert into tbl_type(type_name)values('".$Name."')";
        if($Con->query($insQry))
        {
        ?>
            <script>
...
if(isset($_GET['eid']))
{
	$SelQry=" select * from tbl_type where c='".$_GET['eid']."' ";
	$result=$Con->query($SelQry);
	$data=$result->fetch_assoc();
	$did=$data['type_id'];
	$dname=$data['type_name'];
}
?>
...
<body>
    ...
    <div class="table-container">
        <form id="form2" name="form2" method="post" action="Type.php">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                           <p> <a href="Type.php?did=<?php echo $data['type_id']; ?>">Delete</a></p>
                           <p> <a href="Type.php?eid=<?php echo $data['type_id']; ?>">Edit</a></p>
                        </td>
                    </tr>
                    <?php
                    }
