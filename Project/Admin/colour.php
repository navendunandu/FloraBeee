...
if(isset($_POST['btn_submit']))
{
	...
	if($id!='')
	{
	$upQry=" update tbl_colour set colour_name ='$Name' where colour_id='$id' ";
	if($Con->query($upQry))
	{
		?>
        <script>
...
if(isset($_GET['did'])){
	$delQry="delete from tbl_colour where colour_id=".$_GET['did'];
	if($Con -> query($delQry))
	{
		echo "Deleted";
	}
...
if(isset($_GET['eid']))
{
	$SelQry=" select * from tbl_colour where colour_id='".$_GET['eid']."' ";
	$result=$Con->query($SelQry);
	$data=$result->fetch_assoc();
	$did=$data['colour_id'];
	$dname=$data['colour_name'];
}
?>
...
<body>
    ...
    <div class="form-container">
        <form id="form1" name="form1" method="post" action="Colour.php">
            <div class="mb-3">
    ...
    <div class="table-container">
        <form id="form2" name="form2" method="post" action="Colour.php">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                           <p> <a href="Colour.php?did=<?php echo $data['colour_id']; ?>">Delete</a></p>
                           <p> <a href="Colour.php?eid=<?php echo $data['colour_id']; ?>">Edit</a></p>
                        </td>
                    </tr>
                    <?php
                    }
