...
if(isset($_GET['rid'])){
	...
	if($Con->query($upQry))
	{
    	...
    	<script>
		alert("Rejected")
		window.location="VerifiedSeller.php";
		</script>
        <?php
		 }
}
        ...
        <form id="form1" name="form1" method="post" action="">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <a href="../Assets/Files/Seller/Proof/<?php echo $data['seller_proof']; ?>" target="_blank">
                            <img src="../Assets/Files/Seller/Proof/<?php echo $data['seller_proof']; ?>" alt="Proof">
                        </a>
                    </td>
                    <td>
                        <a href="VerifiedSeller.php?rid=<?php echo $data['seller_id']; ?>">Reject</a>
                    </td>
                </tr>
                <?php
                }
